...
final class CreateTeamsPlayers extends AbstractMigration
{
    public function change(): void
    {
        // team
        $this->table('team')
            ->addColumn('sports_academy_id', 'integer')
            ->addColumn('name', 'string', ['limit' => 80])
            ->addColumn('category_id', 'integer')
            ->addColumn('coach_person_id', 'integer', ['null' => true])
        ...
        $this->table('player', ['id' => false, 'primary_key' => ['person_id']])
            ...
            ->addColumn('current_category_id', 'integer', ['null' => true])
            ->addColumn('sports_academy_id', 'integer', ['null' => true])
